...
- `config` **[Object][110]** 
  - `config.mapId` **([string][111] \| [Array][120]&lt;[string][111]>)** 
  - `config.longitude` **[number][114]** 
  - `config.latitude` **[number][114]** 
...
- `config` **[Object][110]** 
  - `config.points` **[Array][120]&lt;[MatrixPoint][154]>** An ordered array of [`MatrixPoint`][106]s, between 2 and 100 (inclusive).
...
[140]: https://www.mapbox.com/api-documentation/#list-tilesets
