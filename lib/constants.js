...
module.exports.DATASETS = compile('${endpoint}/datasets/v1/${user}?${query}');
module.exports.DATASET = compile('${endpoint}/datasets/v1/${user}/${dataset}?${query}');
module.exports.FEATURES = compile('${endpoint}/datasets/v1/${user}/${dataset}/features?${query}');
module.exports.FEATURE = compile('${endpoint}/datasets/v1/${user}/${dataset}/features/${id}?${query}');
