...
module.exports.API_TILESTATS_STATISTICS = '{endpoint}/tilestats/v1/{owner}/{tileset}';
module.exports.API_TILESTATS_LAYER = '{endpoint}/tilestats/v1/{owner}/{tileset}/{layer}';
module.exports.API_TILESTATS_ATTRIBUTE = '{endpoint}/tilestats/v1/{owner}/{tileset}/{layer}/{attribute}';
