 ...
 * @param {string} options.language Specify the language to be used for
 * response text and query result weighting.
...
MapboxGeocoding.prototype.geocodeForward = function(query, options, callback) {
  ...
  if (options.language) {
    invariant(typeof options.language === 'string', 'language option must be a string');
