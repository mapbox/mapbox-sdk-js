...
var API_DATASET_DATASETS = '/datasets/v1/{owner}{?limit,fresh}';
var API_DATASET_DATASET = '/datasets/v1/{owner}/{dataset}';
var API_DATASET_FEATURES = '/datasets/v1/{owner}/{dataset}/features{?limit}';
var API_DATASET_FEATURE = '/datasets/v1/{owner}/{dataset}/features/{id}';
