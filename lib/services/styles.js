...
var API_STYLES_LIST = '/styles/v1/{owner}';
var API_STYLES_CREATE = '/styles/v1/{owner}';
var API_STYLES_READ = '/styles/v1/{owner}/{styleid}';
var API_STYLES_UPDATE = '/styles/v1/{owner}/{styleid}';
var API_STYLES_DELETE = '/styles/v1/{owner}/{styleid}';
var API_STYLES_EMBED = '/styles/v1/{owner}/{styleid}.html{?zoomwheel,title,access_token}';
var API_STYLES_SPRITE = '/styles/v1/{owner}/{styleid}/sprite{+retina}{.format}';
var API_STYLES_SPRITE_ICON = '/styles/v1/{owner}/{styleid}/sprite/{iconName}';
var API_STYLES_FONT_GLYPH_RANGES = '/fonts/v1/{owner}/{font}/{start}-{end}.pbf';
