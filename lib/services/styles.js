...
var API_STYLES_LIST = '/styles/v1/{owner}{?access_token,limit}';
 ...
 * @param {Number} options.limit Maximum number of styles to return
 * @param {Function} [callback] called with (err, styles, response)
 ...
 * });
 */
Styles.prototype.listStyles = function(options, callback) {
