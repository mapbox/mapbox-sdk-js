...
var API_MATRIX = '/directions-matrix/v1/mapbox/{profile}{?access_token}';
 ...
 *
 * @param {Object<Object<number>>} waypoints an array of coordinate object pairs
 ...
 * bicycle. The `'mapbox/driving-traffic'` profile is not supported.
...
MapboxMatrix.prototype.getMatrix = function(waypoints, options, callback) {
  ...
  // typecheck arguments
  invariant(typeof waypoints === 'object', 'waypoints must be an object');
