...
var API_TILESETS_TILEQUERY = '/v4/{mapid}/tilequery/{longitude},{latitude}.json{?radius,limit}';
var API_TILESETS_LIST = '/tilesets/v1/{owner}';
 ...
 * });
 */
Tilesets.prototype.listTilesets = function(callback) {
  return this.client({
